...
class __TwigTemplate_f84c83d46a31237db08ad184411c96c6 extends Twig_Template
{
...
";
    ...
    public function block_check_uniquity_async_request($context, array $blocks = array())
    {
        ...
        echo "        \$.ajax({
            ...
            url: '";
        // line 20
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("apy_js_form_validation_unique_entity", array("_format" => "json", "_locale" => $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request"), "locale"))), "html", null, true);
        echo "',
            data: {
