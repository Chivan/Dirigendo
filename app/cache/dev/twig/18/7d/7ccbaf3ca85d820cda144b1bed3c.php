...
class __TwigTemplate_187d7ccbaf3ca85d820cda144b1bed3c extends Twig_Template
{
        ...
        echo "function Email(field, params)
{
    ...
    public function block_checkmx_async_request($context, array $blocks = array())
    {
        ...
        echo "\$.ajax({
                ...
                url: '";
        // line 26
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("apy_js_form_validation_checkmx", array("_format" => "json")), "html", null, true);
        echo "',
