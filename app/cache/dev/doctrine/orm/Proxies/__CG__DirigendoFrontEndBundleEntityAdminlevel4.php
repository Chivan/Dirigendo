 ...
 */
class Adminlevel4 extends \Dirigendo\FrontEndBundle\Entity\Adminlevel4 implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setXcoord($xcoord);
    }

    public function getXcoord()
    {
        $this->__load();
        return parent::getXcoord();
    }

    public function setYcoord($ycoord)
    {
        $this->__load();
        return parent::setYcoord($ycoord);
    }

    public function getYcoord()
    {
        $this->__load();
        return parent::getYcoord();
    }

    public function setPc4code($pc4code)
    {
        $this->__load();
        return parent::setPc4code($pc4code);
    }

    public function getPc4code()
    {
        $this->__load();
        return parent::getPc4code();
    }

    public function setPc3code($pc3code)
    {
        $this->__load();
        return parent::setPc3code($pc3code);
    }

    public function getPc3code()
    {
        $this->__load();
        return parent::getPc3code();
    }

    public function setPc2code($pc2code)
    {
        $this->__load();
        return parent::setPc2code($pc2code);
    }

    public function getPc2code()
    {
        $this->__load();
        return parent::getPc2code();
    }

    public function setPc1code($pc1code)
    {
        $this->__load();
        return parent::setPc1code($pc1code);
    }

    public function getPc1code()
    {
        $this->__load();
        return parent::getPc1code();
    }
    ...
    {
        $this->__load();
        return parent::setAdminlevel3name($adminlevel3name);
    }

    public function getAdminlevel3name()
    {
        $this->__load();
        return parent::getAdminlevel3name();
    }
    ...
    {
        $this->__load();
        return parent::setAdminlevel3id($adminlevel3id);
    }

    public function getAdminlevel3id()
    {
        $this->__load();
        return parent::getAdminlevel3id();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'xcoord', 'ycoord', 'pc4code', 'pc3code', 'pc2code', 'pc1code', 'adminlevel1name', 'adminlevel2name', 'adminlevel3name', 'geom', 'adminlevel3id', 'adminleveltypeid', 'adminlevel1id', 'adminlevel2id');
    }
