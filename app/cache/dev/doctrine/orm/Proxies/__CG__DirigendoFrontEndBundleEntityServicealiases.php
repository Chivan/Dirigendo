 ...
 */
class Servicealiases extends \Dirigendo\FrontEndBundle\Entity\Servicealiases implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'alias', 'serviceid');
    }
