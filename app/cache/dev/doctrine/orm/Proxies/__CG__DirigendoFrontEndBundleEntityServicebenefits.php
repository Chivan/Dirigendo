 ...
 */
class Servicebenefits extends \Dirigendo\FrontEndBundle\Entity\Servicebenefits implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'header', 'text', 'serviceid');
    }
