...
$catalogue = new MessageCatalogue('en', array (
  ...
  array (
    ...
    'validator.recaptcha.empty' => 'Recaptcha element is empty',
    'validator.recaptcha.invalid' => 'Recaptcha element is not valid',
    'exception.image.open' => 'Image with name "{name}" can not be opened.',
    'exception.image.out_of_bounds' => 'Image with name "{name}" has not valid crop coordinates.',
    'exception.image.crop' => 'Image with name "{name}" is invalid.',
    'upload_progress' => 'Upload progress',
    'button_upload_title' => 'Upload',
    'button_title_enabled' => 'enable/disable',
    'button_view_title' => 'Preview',
    'button_crop_title' => 'Crop',
    'button_edit_meta_title' => 'Meta',
    'button_rotate_title' => 'Rotate',
    'button_reset_title' => 'Reset',
    'button_remove_title' => 'Reset',
    'dialog_crop_title' => 'Croping',
    'dialog_crop_button_cancel' => 'Cancel',
    'dialog_crop_button_crop' => 'Crop',
    'dialog_edit_meta_title' => 'Meta information',
    'dialog_edit_meta_label_title' => 'Meta title',
    'dialog_edit_meta_label_caption' => 'Meta caption',
    'dialog_edit_meta_label_description' => 'Meta description',
    'dialog_edit_meta_button_done' => 'Done',
    'drag_drop_image_text' => 'Drag and drop images here',
    'no_images_found' => 'No images found',
    'no_file_uploaded' => 'No file uploaded',
    'no_filename' => 'No filename',
    'drag_drop_file_text' => 'Drag and drops files here',
    'no_file_text' => 'No files',
    'multi_select_sortable.error' => 'Row already exists.',
    'multi_select_sortable.description' => 'Drag and drop rows here',
  ),
  ...
  array (
    ...
    'custom_button_dlg_title' => 'Error',
    'custom_button_dlg_body' => 'Please select row',
  ),
));
