...
/* APYJsFormValidationBundle:Constraints:ServiceValidator.js.twig */
class __TwigTemplate_292de04721308304da344d48b62e2043 extends Twig_Template
{
    ...
    {
        // line 1
        echo "function Service(field, params)
{
...
url: '";
        // line 12
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_validateService"), "js", null, true);
...
return getComputeMessage(params.message);
    ...
    {
        return "APYJsFormValidationBundle:Constraints:ServiceValidator.js.twig";
    }
