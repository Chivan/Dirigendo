 ...
 */
class Subcategoryservices extends \Dirigendo\FrontEndBundle\Entity\Subcategoryservices implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'serviceid', 'subcategoryid');
    }
