 ...
 */
class Carrousel extends \Dirigendo\FrontEndBundle\Entity\Carrousel implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'image', 'title', 'link', 'text', 'order', 'serviceid');
    }
