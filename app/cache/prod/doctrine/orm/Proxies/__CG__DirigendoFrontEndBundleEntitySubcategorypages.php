 ...
 */
class Subcategorypages extends \Dirigendo\FrontEndBundle\Entity\Subcategorypages implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'title', 'description', 'keywords', 'contentbox1', 'contentbox2', 'timestamp', 'subcategoryid');
    }
