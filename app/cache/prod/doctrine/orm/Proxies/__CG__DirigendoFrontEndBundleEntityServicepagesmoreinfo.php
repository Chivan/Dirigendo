 ...
 */
class Servicepagesmoreinfo extends \Dirigendo\FrontEndBundle\Entity\Servicepagesmoreinfo implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'title', 'keywords', 'description', 'tagline', 'taglinetextsize', 'contentbox1', 'timestamp', 'serviceid');
    }
