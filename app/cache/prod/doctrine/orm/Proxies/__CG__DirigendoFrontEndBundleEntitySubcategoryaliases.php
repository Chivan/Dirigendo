 ...
 */
class Subcategoryaliases extends \Dirigendo\FrontEndBundle\Entity\Subcategoryaliases implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'alias', 'subcategoryid');
    }
